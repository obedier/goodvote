...
async function optimizeCongressionalDistrictsFixed() {
  try {
...
optimizeCongressionalDistrictsFixed().then(success => {
  if (success) {
    console.log('\n🎉 Fixed optimization completed successfully!');
  } else {
    console.log('\n💥 Fixed optimization failed!');
    process.exit(1);
  }
});
